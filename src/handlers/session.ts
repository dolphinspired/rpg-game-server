...
export class SessionController extends CommandController {
  ...
  async open(m: SessionMessage, c: MessageHandlerContext): Promise<void> {
  ...
  async close(m: SessionMessage, c: MessageHandlerContext): Promise<void> {
  ...
  async join(m: SessionMessage, c: MessageHandlerContext): Promise<void> {
  ...
  async leave(m: SessionMessage, c: MessageHandlerContext): Promise<void> {
    if (!c.currentSession) {
